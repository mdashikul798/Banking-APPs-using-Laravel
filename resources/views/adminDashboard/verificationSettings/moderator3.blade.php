                            ...
                            <div class="panel-body" style="padding: 40px">
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6" style="">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                            <input name="code2" class="form-control" value="{{ isset($userdata->code2) ? $userdata->code2 : ''}}"   placeholder="Entrez le code 2"  type="text">
                                        </div>
                                            </div>
                                        @if ($errors->has('code2'))
                                            <span class="" style="color:red;">
                                ...
                                <!--        <div class="input-group">-->
                                <!--            <span class="input-group-addon"><i class="fa fa-lock"></i></span>-->
                                <!--            <input name="code3" class="form-control" value="{{ isset($userdata->code3) ? $userdata->code3 : ''}}"   placeholder="Entrez le code 3"  type="text">-->
                                <!--        </div>-->
                                <!--            </div>-->
                                <!--        @if ($errors->has('code3'))-->
                                <!--            <span class="" style="color:red;">-->
