...
<div class="main">
    ...
    <div class="main-content">
        <div class="container-fluid">
            <h3 class="page-title">Mettre à jour le fichier de suivi</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-md-offset-1" id="profileform" >
                    ...
                    <div class="panel panel-headline">
                        <form method="POST" action="{{route('updatetrackfile')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="panel-body" style="padding: 40px">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-md-offset-3 col-sm-offset-3">
                                        <div class="form-group">
                                            <textarea class="form-control" rows="5" id="comment" name="message" placeholder="Message">{{$tracking->message}}</textarea>
                                        </div>
                                    ...
                                    <input type="hidden" name="trackid" value="{{$tracking->id}}">
