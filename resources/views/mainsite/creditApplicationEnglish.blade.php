    ...
    <div class="row" style="margin-top: 50px; margin-bottom: 50px">
        <div class="col-xs-12 col-sm-8 col-md-6 offset-sm-2 offset-md-3" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            ...
            <div style="padding-top: 30px;margin-bottom: 0px !important;">
                <p style="font-size: 17px;font-weight: 800;text-align: center;color: #337ab7">Find FUNDING OFFER FOR YOUR NEEDS.</p>
            </div>
            <div style="padding-bottom: 5px;margin-top: -20px !important;">
                <p style="font-size: 17px;font-weight: 800;text-align: center">
                    Ask for   <span style="color: firebrick">€3000</span> to
            ...
            <form role="form" method="POST" action="{{route('creditapplication')}}">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="input-group">
                            ...
                            <input id="name" type="text" class="form-control" value="{{ old('name') }}" name="name" placeholder="Enter Your First & Last Name ">
                        </div>
                        @csrf
                        @if ($errors->has('name'))
                ...
                <div class="row" style="margin-top:14px;margin-bottom:5px;">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="input-group">
                            ...
                            <input id="email" type="text" class="form-control" value="{{ old('email') }}" name="email" placeholder="Enter Your Email">
                        </div>
                        @if ($errors->has('email'))
                            <span class="" style="color:red;">
                ...
                <div class="row" style="margin-top:14px;margin-bottom:5px;">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="input-group">
                            ...
                            <input id="phone" type="text" class="form-control" value="{{ old('phone') }}" name="phone" placeholder="Enter Your Phone ">
                        </div>
                ...
                <div class="row" style="margin-top:14px">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="input-group">
                            ...
                            <input id="loan" type="text" class="form-control" value="{{ old('loan') }}" name="loan" placeholder="Loan Amount ">
                        </div>
                        @if ($errors->has('loan'))
                            <span class="" style="color:red;">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                            <textarea class="form-control" rows="5" id="comment" name="address" placeholder="Address">{{ old('address') }}</textarea>
                        </div>
                ...
                <div class="row" style="padding-bottom: 30px">
                    <div class="col-xs-12 col-md-6 col-md-offset-3 col-sm-offset-3"><input style="color:white;font-size: 16px;padding-top: 11px;padding-bottom: 11px;;letter-spacing: 2px;" type="submit" value="Submit" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
                </div>
