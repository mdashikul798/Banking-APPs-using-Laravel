                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div  class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 " >
                            ...
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped progress-bar-success" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="max-width: 75%">
                        ...
                        <form   style="display:none" class="fade_me form-horizontal form-label-left input_mask" method="POST" action="{{route("secondverification")}}">
                            @csrf
