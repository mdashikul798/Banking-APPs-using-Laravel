@section('assets')
    <style>
        .progress-bar {
            width: 0;
            animation: progress 25.5s ease-in-out forwards;
        }
        .title {
            opacity: 0;
            animation: show 2.0s forwards ease-in-out 19.0s;
        }
                ...
                <div class="x_panel">
                    <div class="x_title">
                        @if (Session::has('success'))
                            <div class="alert alert-success">
                               <p>Transaction Successfull. Please <a href="{{route('userdashboard')}}">click here</a> to return to main menu and check your account balance.</p>
                            </div>
                        @endif
                        <h2>Vérification</h2>
                    ...
                    <div class="x_content">
                        ...
                        <div  class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 " >
                            ...
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped progress-bar-success" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="max-width: 90%">
                        ...
                        <form   style="display:none" class="fade_me form-horizontal form-label-left input_mask" method="POST" action="{{route("thirdverification")}}">
                            @csrf
        ...
        $("document").ready(function () {
            ...
            $('.progress-bar').animate(
                    {width:'90%'},
                    {
                        ...
                        $(".fade_me").fadeIn().css("display","inline");
